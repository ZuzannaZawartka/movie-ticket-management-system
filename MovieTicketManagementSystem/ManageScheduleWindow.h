...
public:
    explicit ManageScheduleWindow(QComboBox* titleEdit, QDateEdit* dateEdit, QTimeEdit* timeEdit,  QLineEdit* durationTime, QPushButton* addButton, QTableWidget* scheduleTableWidget);
